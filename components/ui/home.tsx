...
export function SplineSceneBasic() {
  return (
    <Card className="w-full h-screen bg-hidden relative overflow-hidden">
      <Spotlight
...
<div className="flex items-center gap-4   ">
  <div className="social-button motion-preset-pop ">
    ...
    <button className="relative w-12 h-12 rounded-full group cursor-pointer">
      ...
      <div
        className="floater w-full h-full absolute top-0 left-0 bg-gray-700 rounded-full "
      ></div>
      <div
      ...
      >
        ...
        >
          <path
            className="group-hover:fill-[#2c2c2f] fill-white duration-300"
  ...
  <div className="social-button motion-preset-pop ">
    ...
    <button className="relative w-12 h-12 rounded-full group cursor-pointer">
      ...
      <div
        className="floater w-full h-full absolute top-0 left-0 bg-blue-500  rounded-full "
      ></div>
      <div
        className="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-white  rounded-full"
      >
       <svg
        ...
        >
          <path
            className="group-hover:fill-[#101819] fill-white duration-300"
  ...
  <div className="social-button motion-preset-pop ">
    ...
    <button className="relative w-12 h-12 rounded-full group cursor-pointer">
      ...
      <div
        className="floater w-full h-full absolute top-0 left-0 bg-sky-400 rounded-full "
      ></div>
      <div
        className="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-white rounded-full"
      >
  ...
  <div className="social-button motion-preset-pop ">
    ...
    <button className="relative w-12 h-12 rounded-full group cursor-pointer">
      ...
      <div
        className="floater w-full h-full absolute top-0 left-0 bg-red-400 rounded-full "
      ></div>
      <div
        className="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-white rounded-full"
      >
